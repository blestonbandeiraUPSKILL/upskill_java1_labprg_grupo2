...
public class GestorLogadoUI implements Initializable {
    ...
    @FXML
    private TextArea txtDescricaoTecnica1;

    @FXML
    private ComboBox<?> cmbAreaActividade1;

    @FXML
    private Button btnCancelarRegCol;

    @FXML
    private Button btnRegistarColaborador;

    @FXML
    private Button btnRegistarTarefa1;

    @FXML
    private TextField txtDesignacao1;
    ...
    @FXML
    private ComboBox<?> cmbCategoriaTarefa1;

    @FXML
    private ListView<?> listViewCompTec1;

    @FXML
    private TextField txtReferencia1;

    @FXML
    private ComboBox<?> cmbArAct;

    @FXML
    private TextField txtEmailColaborador;

    @FXML
    private TextField txtDuracao1;

    @FXML
    private TextField txtCusto1;

    @FXML
    private TextArea txtDescricaoInformal1;

    @FXML
    private TextField txtTelefoneColaborador;
