...
public class ConsultarAnuncioUI implements Initializable {
    ...
    @FXML
    TextField txtDtInPublicitacao;
    @FXML
    TextField txtDtFimPublicitacao;
    @FXML
    TextField txtDtInCandidatura;
    @FXML
    TextField txtDtFimCandidatura;
    @FXML
    TextField txtDtInSeriacao;
    @FXML
    TextField txtDtFimSeriacao;
    @FXML
    TextField txtTipoRegDesignacao;
    @FXML
    TextField txtRegras;
    @FXML
    ...
    @FXML
    TextField txtDuracao;
    @FXML
    TextField txtCusto;
    @FXML
    TextField txtDescInformal;
    @FXML
    TextField txDescTecnica;
    @FXML
    Button btnVoltar;
